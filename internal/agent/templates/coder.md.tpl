...
15. **LIMIT FILE READS**: Avoid reading entire files, as they can be very large. Read only the sections you need using 'offset' and 'limit' parameters. Use 'grep' to locate the relevant lines first, then read just the surrounding context.
</critical_rules>
